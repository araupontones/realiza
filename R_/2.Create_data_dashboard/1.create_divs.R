...
exfile <- 'data/2.Dashboard/divs.rds'
#read data =====================================================================
#This data is created in R_/1.Get_data_zoho/2.clean_reports.R
presencas <- import("data/1.zoho/2.clean_reports_zoho.rds")
